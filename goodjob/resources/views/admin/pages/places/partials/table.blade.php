...
<!-- Page content-->
  <div class="container">
      ...
      <div class="addnew d-inline-block w-100">
          ...
          <a class="float-end ms-auto" href="{{ route('places.create') }}"> <img src="{{ asset('assets') }}/images/icon-add.png"> </a>
      </div>
      <div class="row mb-5">
          <div class="col-md-12">
                        ...
                        <thead>
                          <tr>
                              ...
                              <th>@lang('messages.job_title')</th>
                               ...
                               <th>@lang('messages.scheduled')</th>
                               <th>@lang('messages.assign_to')</th>
