...
<!-- Page content-->
  <div class="container">
      ...
      <div class="addnew d-inline-block w-100">
          ...
          <a class="float-end ms-auto" href="{{ route('skills.create') }}"> <img src="{{ asset('assets') }}/images/icon-add.png"> </a>
      </div>
      <div class="row mb-5">
          <div class="col-md-12">
              <div class="white-box px-0">
                  <div class="table-responsive">
                      <table class="emp-table table" id="datatables-skills">
                        <thead>
                          <tr>
  ...
  <script type="text/javascript">
    ...
    function get_checked_value(type){
      ...
      var encoded_ids = [];
        ...
        if(allVals.length){
          if(type == 'edit'){
            window.location.href = "/admin/skills/"+encoded_ids[0]+"/edit";
          }else if(type == 'delete'){

            alertify_func_post(encoded_ids,"{{ route('delete.skills') }}")
            // alert(allVals);
          }else if(type == 'deublicate'){
            window.location.href = "/admin/skills/create?id="+encoded_ids[0];
          }
        }
    }
